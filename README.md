...
| T2 | OrderController | images | Verify that the players method retrieves the authenticated user's orders | The method should return the correct view with the user's orders | Passed |
